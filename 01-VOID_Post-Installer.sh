...
# Ver  : 0.2
# Date : 16/11/2020 maj 28/10/2021
...
sudo vpm i -y nano notepadqq mc htop tmux zsh curl wget cifs-utils xarchiver xfburn flatpak smbclient minitube arduino zenmap vlc gimp gparted blender pycp cdrtools git-all socklog socklog-void;
